            ...
            <div className="row">
                    ...
                    <div className="contact-address contact-wraper">
                       <div className="sin-add">
                          <div className="add-icon">
                           ...
                           <p className="phone">Phone: <Link to="tel:+0172554">+0172554456</Link></p>
                       </div>
                       <div className="sin-add">
                          <div className="add-icon">
                        ...
                        <p className="mail">
                            Email:<Link to="mailto:raza_box@yourdomain.com">raza_box@yourdomain.com</Link>
                        </p>
                       </div>
                        <div className="sin-add">
                          <div className="add-icon">
                ...
                <div className="col-sm-7 col-md-8  ">
                    <div className="contact-wraper bg-dark">
                        <form className="contact-form" id="contact-form" action="mail.php" method="post">
