            ...
            <div className="row">
              <div className="work-filter">
                <ul className="mixitup-button">
                  ...
                  <li className="filter active" data-filter=".five">web</li>
                </ul>
                <div className="" id="">
                  {this.state.items.map((item, i) => {
                    return (
                      <div key={i} className="mix two col-xs-12 col-sm-6  col-md-4" style={{ display: 'inline-block' }} data-bound="">
                        <div className="mix-wrapper">
                          ...
                          <div className="work-icon">
                            ...
                            <Link to="http://obxtheme.com/demopreview/bizcan/img/filter/m13.jpg" data-lightbox="image-1" data-title="My caption"><i className="fa fa-search" aria-hidden="true"></i></Link>
                          </div>
                        </div>
                      </div>
                ...
                {/* <ReactMixitup
                  ...
                  renderCells={items => (
                    <div className="mixitup-content" id="mixstart">
                      {this.state.items.map((item, i) => {
                        return (
                          <div className="mix five col-xs-12 col-sm-6  col-md-4" data-bound="" style={{ display: 'inline-block' }}>
                            <div className="mix-wrapper">
                              <img className="http://obxtheme.com/demopreview/bizcan/img/filter/m5.jpg" alt="" />
                              <div className="overlay"></div>
                              <div className="work-icon">
                                <div className="work-des"><p>still life picture</p></div>
                                <Link to=""><i className="fa fa-link" aria-hidden="true"></i></Link>
                                <Link to="img/filter/m5.jpg" data-lightbox="image-1" data-title="My caption"><i className="fa fa-search" aria-hidden="true"></i></Link>
                              </div>
                            </div>
                          </div>
                        )
